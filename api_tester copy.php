 ...
 *
 * Versión 3: Permite elegir entre usar una cámara guardada en la BD
 * o introducir los datos de conexión (IP, usuario, contraseña) manualmente.
 */
...
<head>
    ...
    <style>
        /* Estilos de la versión anterior, no cambian */
    ...
    <div class="tester-container">
        ...
        <div class="form-section">
            ...
            <form action="api_tester.php" method="POST" id="api-form">
                ...
                <!-- Contenedor para la selección de cámara guardada -->
                ...
                <!-- Contenedor para los campos de conexión manual -->
                ...
                <div class="form-group">
                    ...
                    <select id="predefined_endpoint" class="form-control">
                        ...
                        <option value="trigger_barrier">Activar Barrera (Relé 1)</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    toggleConnectionFields(); // Set initial state on page load

    const predefinedEndpoints = {
        'get_time': { endpoint: '/ISAPI/System/time', method: 'GET', body: '' },
        'trigger_barrier': { endpoint: '/ISAPI/System/IO/outputs/1/trigger', method: 'PUT', body: '<IOCtrl>\n \t<id>1</id>\n \t<outputState>high</outputState>\n</IOCtrl>' },
        
        'add_plate': {
    endpoint: '/ISAPI/Traffic/channels/1/licensePlateAuditData/record?format=json',
    method: 'PUT',
    body: '{\n \t"LicensePlateInfoList": [\n \t\t{\n \t\t\t"LicensePlate": "TEST123",\n \t\t\t"listType": "whiteList",\n \t\t\t"createTime": "2025-08-02T17:18:57",\n \t\t\t"effectiveStartDate": "2025-08-02",\n \t\t\t"effectiveTime": "2025-08-02",\n \t\t\t"id": ""\n \t\t}\n \t]\n}'
},
